...
execute (
        replace view &tdStagedb..&table_target. as
				...
				AND LEGAL_ENTITY_CD in (  'A2136', 'A2458', '137', 'A1966', '135', 'A3112', '133', '022', '035', 'A1983', '662', '032', '001'  ) 
				AND LEGAL_ENTITY_CPT_CD in (  'A2136', 'A2458', '137', 'A1966', '135', 'A3112', '133', '022', '035', 'A1983', '662', '032', '001'  )
				AND CATEGORY <>  '$AMOUNT'  
				AND CATEGORY <> 'IC'
