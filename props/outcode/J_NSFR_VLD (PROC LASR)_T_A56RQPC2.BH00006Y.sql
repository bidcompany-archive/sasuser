...
/*
  ...
  FROM P_KGU_GLM_UES.GLRT_WTE_NSFR WTE left join P_DSASVA_STG18.US_TEC_COUNTRY_TABLE t2 
    on WTE.NSFR_INDIVIDUAL_LE_CD = t2.BRANCH_CD 
      ...
      on WTE.NSFR_CONSOLIDATED_LE_CD = t3.BRANCH_CD
      /*
        left join P_DSASVA_STG18.US_TEC_COUNTRY_TABLE t4 
        on WTE.LEGAL_ENTITY_CD = t3.BRANCH_CD
      */) a2
