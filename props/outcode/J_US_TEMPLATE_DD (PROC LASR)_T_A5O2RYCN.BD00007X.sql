...
execute(replace view &tdStagedb..US_row_180 as
         (%select_sum(%quote('180'),%quote('180a','180b'),%quote('BAZINGA'))
         )
        ) by teradata;

execute(replace view &tdStagedb..US_row_190 as
...
execute(replace view &tdStagedb..US_row_380 as
...
union all
 (select * FROM &tdStagedb..US_ROW_010b)

union all
 (select * FROM &tdStagedb..US_ROW_010c6)

union all
 (select * FROM &tdStagedb..US_ROW_020a6)

union all
 (select * FROM &tdStagedb..US_ROW_050) 

union all
 (select * FROM &tdStagedb..US_ROW_060) 

union all
 (select * FROM &tdStagedb..US_ROW_070) 

union all
 (select * FROM &tdStagedb..US_ROW_080) 

union all
 (select * FROM &tdStagedb..US_ROW_080a) 

union all
 (select * FROM &tdStagedb..US_ROW_080b) 

union all
 (select * FROM &tdStagedb..US_ROW_090) 

union all
 (select * FROM &tdStagedb..US_ROW_110)) 

union all
 (select * FROM &tdStagedb..US_ROW_130) 

union all
 (select * FROM &tdStagedb..US_ROW_160) 

union all
 (select * FROM &tdStagedb..US_ROW_170) 

union all
 (select * FROM &tdStagedb..US_ROW_180)

union all
 (select * FROM &tdStagedb..US_ROW_190)

union all
 (select * FROM &tdStagedb..US_ROW_300)

union all
 (select * FROM &tdStagedb..US_ROW_350) 

union all
 (select * FROM &tdStagedb..US_ROW_360) 

union all
 (select * FROM &tdStagedb..US_ROW_370) 

union all
 (select * FROM &tdStagedb..US_ROW_380) 
