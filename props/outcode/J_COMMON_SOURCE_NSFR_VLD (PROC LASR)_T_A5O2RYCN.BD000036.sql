...
execute (
    ...
    FROM   P_KGU_GLM_UES.GLRT_COMMON_SOURCE_V_NSFR t1 left join &tdStagedb..NSFR_Distinct_NOCFL1 t2
        on /*trim(cast(t1.SK_ID_NOCFL as VARCHAR(20)))=trim(t2.SK_ID_NOCFL)*/
           cast(t1.SK_ID_NOCFL as VARCHAR(20))=t2.SK_ID_NOCFL
    )         
)  by teradata;
